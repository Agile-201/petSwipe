    ...
    return(
        <div className="bg-[#A0CAF0CC] h-[260px] flex items-center">
            ...
            <div className="ml-[40px] flex flex-col gap-y-2">
                ...
                <Link href=""><div className="text-[16px] font-light">Политика конфиденциальности</div></Link>
                <Link href=""><div className="text-[16px] font-light">Условия использования</div></Link>
            </div>

            <div className="ml-auto mr-[150px] flex flex-col">
                <div className="text-[20px] font-bold w-[377px] text-[#0F1B65]">Если у вас остались вопросы, свяжитесь с нами:</div>

                <Input
                    type="email"
                    placeholder="Email:"
                    className="mt-5 mb-3 rounded-[30px] h-[44px] w-[454px] p-[20px]
                ...
                <Input
                    type="text"
                    placeholder="Вопрос:"
                    className="mb-5 rounded-[30px] h-[44px] w-[454px] p-[20px]
                        text-[#0F1B65DB] text-[16px]
                        border border-[#0F1B65DB]
                        outline-none focus:outline-none focus:ring-0 focus:ring-offset-0
                        focus-visible:outline-none focus-visible:ring-0
                ...
                <div className="justify-self-end">
                    <Button className="flex justify-self-end bg-[#0F1B65] h-[40px] rounded-[20px] w-[149px] font-normal">
                        Отправить
                    </Button>
                </div>
            </div>
